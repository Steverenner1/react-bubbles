...
A token is a piece of data created by a server, and contains information to identify a particular user and validity.

- [ ] What steps can you take in your web apps to keep your data secure?
Testing, keeping everything up to date, using authentication tokens, having a strong password policy, using encryption.

- [ ] Describe how web servers work.
A web server stores a website’s component files and is connected to the internet and supports data interchange with other devices connected to the web.
